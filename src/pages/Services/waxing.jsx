          ...
          <div className="col-lg-12 order-0 order-lg-2">
            ...
            <div id="slider1" className="beer-slider" data-start="50">
              ...
              <div className="services-details-content">
                ...
                <p>
                Tile and grout surfaces can be difficult to keep clean over time, especially in high-traffic areas. Our Tile and Grout Cleaning restores their original shine, removing dirt, grime, and stains that regular cleaning leaves behind.
                <br/>
